<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="SearchCustomer.aspx.cs" Inherits="Bank.UI.SearchCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HomeContentPlaceHolder" runat="server">
     ...
     <div>
        ...
        <table title="Search Customer">
            <asp:Label ID="TableTitleLabel" Font-Size="Large" Font-Bold="true" runat="server" Text="Search Customers"></asp:Label>
